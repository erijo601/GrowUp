class Cutscene {
    ...
    private textStart: PIXI.Sprite;
    private textEnd: PIXI.Sprite;
    private head: PIXI.Sprite;
    private handPoint: PIXI.Sprite;
    private handEmpty: PIXI.Sprite;
    private handCoffee: PIXI.Sprite;
    private cup: PIXI.Sprite;
    private eye: PIXI.Sprite;
    private coffee: PIXI.Sprite;
    private instructions: PIXI.Sprite;

    private currentState: number;
    private timeElapsedCurrentStateTransition: number;
    private totalTransitionTime: number;
    private isTransition: boolean;

    private timeLeftCurrentFrameCoffee;
    private currentFrameCoffee;
    private cupsHad: number;

    private timeLeftCurrentFrameInstructions;
    private currentFrameInstructions

    constructor(x: number, y: number, player: number, upKey: string, downKey: string, leftKey: string, rightKey: string, scoreCounter: ScoreCounter) {
    ...
    public showStartText(partElapsed: number) {
    ...
    public showEndText(partElapsed: number) {
    ...
    private updateSprites(state: number, partElapsed: number) {
        ...
        if (state == 0) {
            ...
            if (partElapsed > 0.9) {
                ...
                let partHead = (partElapsed - 0.9) / 0.1;
